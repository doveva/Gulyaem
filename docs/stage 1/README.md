...
| [`validation-report.md`](validation-report.md) | Фактические результаты и freeze Stage 1 |
...
Проверены три representative среды, пять маршрутов, bbox performance, grade-aware coverage и
визуальная целостность сети. Результаты находятся в
[`validation-report.md`](validation-report.md).

Stage 1 geo semantics зафиксированы принятыми решениями:

- [`ADR-0007`](../adr/0007-street-segment-stage1-freeze.md) — topology и WalkabilityProfile;
- [`ADR-0008`](../adr/0008-coverage-parameters-stage1-freeze.md) — Balanced coverage;
- [`ADR-0009`](../adr/0009-bbox-geojson-stage2.md) — bbox + GeoJSON delivery.
